...
import numpy as np
from data import Rna8fByRnaFamilyDataset, SynthesizedDataset, MergedDataset
...
def get_args():
    ...
    # for syn
    parser.add_argument('--syn_root_path', type=str, 
                        default='')
...
syn_root_path = args.syn_root_path
...
syn_dataset = SynthesizedDataset(syn_root_path, 'train', seq_len)
final_train_dataset = MergedDataset([train_dataset, syn_dataset], 'train', seq_len)
